...
const OrderForm = ({ formChange, formSubmit, userValue }) => {
  
  return (
    <div className="order-form-container">
      <form className="order-form" onSubmit={formSubmit}>
        <h4>Order Input Form</h4>
        <input type="text" value={userValue} placeholder="user id" onChange={formChange} /><br />
        ...
        <input type="submit" className="submit-button" onChange={formChange} />
      </form>
    </div>
  )
}
